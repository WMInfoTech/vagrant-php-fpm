...
class { 'php_web':
  php_ini_params => {
    ...
    disable_functions    => 'pcntl_alarm,pcntl_fork,pcntl_waitpid,pcntl_wait,pcntl_wifexited,
                             ...
                             pcntl_exec,pcntl_getpriority,pcntl_setpriority,exec,shell_exec,phpinfo,
                             eval,system,passthru,proc_open,show_source,apache_child_terminate,
                             apache_setenv,symlink,chgrp,chown,posix_getpwuid,posix_kill,posix_mkfifo,
